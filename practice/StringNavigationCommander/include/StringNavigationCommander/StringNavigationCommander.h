// -*- C++ -*-
/*!
 * @file  StringNavigationCommander.h
...
#ifndef STRINGNAVIGATIONCOMMANDER_H
#define STRINGNAVIGATIONCOMMANDER_H
...
/*!
 * @class StringNavigationCommander
 * @brief Navigation Manager RTC
 *
 */
class StringNavigationCommander
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  StringNavigationCommander(RTC::Manager* manager);
 ...
 protected:
  ...
  /*!
   */
  RTC::CorbaConsumer<RTC::OGMapServer> m_OGMapServer;
  /*!
   */
...
extern "C"
{
  DLL_EXPORT void StringNavigationCommanderInit(RTC::Manager* manager);
};

#endif // STRINGNAVIGATIONCOMMANDER_H
